...
public class LoggedInScreenFactory {
    public static LoggedInView create(ViewManagerModel viewManagerModel, MapViewModel mapViewModel, TopNewsViewModel topNewsViewModel, SearchViewModel searchViewModel, FavouriteViewModel favouriteViewModel, SeeFavouritesViewModel seeFavouritesViewModel, HistoryViewModel historyViewModel, SeeHistoryViewModel seeHistoryViewModel, FavouriteDataAccessObject favouriteDataAccessObject, HistoryDataAccessObject historyDataAccessObject, LoggedInViewModel loggedInViewModel) {
        try {
            ...
            return new LoggedInView(mapController, topNewsController, searchController, favouriteController, seeFavouritesController, historyController, seeHistoryController, mapViewModel, topNewsViewModel, searchViewModel, favouriteViewModel, seeFavouritesViewModel, historyViewModel, seeHistoryViewModel, loggedInViewModel);
