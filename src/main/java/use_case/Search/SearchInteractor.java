...
public class SearchInteractor implements SearchInputBoundary{
     ...
     * Gets the articles related to the keyword entered by the user. If no articles appear, it moves to Fail view otherwise goes to Success view
     */
